...
$sql = "SELECT * FROM reports WHERE id_patient = $user_id";
...
<form method="get" action="">    
    <div class="row mb-3">
        ...
        <div class="col" >
            <input type="text" class="form-control" placeholder="วันที่" name="date">
        </div>
        <div class="col" >
            <input type="text" class="form-control" placeholder="เวลา" name="timeInput">
        </div>
    ...
    if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_assoc()) {
            ...
            echo "<tr><th scope='row'>วันที่</th><td>" . $row['date'] . "</td></tr>";
            echo "<tr><th scope='row'>เวลา</th><td>" . $row['timeInput'] . "</td></tr>";
