				...
				<div class="container">
				  ...
				  <div class="row">
					<div class="span3">
					  ...
					  <div class="roles">
						<h5><strong>Doctor E (หมออี)</strong></h5>
						<p>
                            ทันตแพทย์ชำนาญการพิเศษ
						</p>
						<h7>อายุ: 28 ปี เพศ: หญิง สัญชาติ: ไทย</h7> 
				...
				<div class="col-md-8">
					<div class="col-md-9">
						<div class="card-body">
							...
							<div class="row pt-1">
								<div class="col-12 mb-6">
									<h6>สาขาที่ประจำการ: สาขากำแพงเพชร</h6>
