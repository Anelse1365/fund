				...
				<div class="container">
				  ...
				  <div class="row">
					<div class="span3">
					  ...
					  <div class="roles">
						<h5><strong>Doctor C (หมอซี)</strong></h5>
						<p>
                            ทันตแพทย์
						</p>
						<h7>อายุ: 30 ปี เพศ: ชาย สัญชาติ: ไทย</h7> 
				...
				<div class="col-md-8">
					<div class="col-md-9">
						<div class="card-body">
							<center>
								<hr class="mt-0 mb-7">
							<h2>สายงานที่เชี่ยวชาญ </h2>
							<hr class="mt-0 mb-7">
							<div class="row pt-1">
								<div class="col-12 mb-6">
									<h6>ผ่าตัดฝังรากฟันเทียม</h6>
									
									<h6>ถอนฟัน ผ่าฟันคุด ผ่าฟันฝัง</h6>
									
									<h6>ผ่าตัดขากรรไกรร่วมกับการจัดฟัน</h6>
									<hr class="mt-1 mb-6">
							...
							<div class="row pt-1">
								<div class="col-12 mb-6">
									<h6>สาขาที่ประจำการ: สาขาพิษณุโลก</h6>
									<h6>จบการศึกษาจาก: มหาวิทยาลัยนเรศวร</h6>
									<h6 style="color : rgb(115, 115, 115); font-weight : bold">Email: moreA@gmail.com</h6>
									<h6 style="color : rgb(115, 115, 115); font-weight : bold">Phone: 011-1111-111</h6>
									<hr class="mt-1 mb-6">
								</div>
							</div>
